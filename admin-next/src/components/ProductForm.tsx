...
import { fetchProduct, createProduct, updateProduct } from '../lib/api/products';
import { fetchCategories, createCategory } from '../lib/api/categories';
import MediaManager from './MediaManager';
import VariantOptions, { deriveOptionsFromVariants } from './VariantOptions';
    ...
    <div className="p-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={() => router.push('/products')} className="btn-secondary">Cancel</button>
        </div>
      </form>
    </div>
  );
