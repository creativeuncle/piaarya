...
import { fetchReturns, setReturnStatus, setPickupStatus, setRefundStatus } from '../../../lib/api/returns';
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/returns/new" className="bg-gray-900 text-white text-sm px-4 py-2 rounded-md hover:bg-gray-800">
          New Return / Exchange
        </Link>
      </div>
