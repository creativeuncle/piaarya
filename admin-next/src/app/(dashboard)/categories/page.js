  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/categories/new" className="bg-gray-900 text-white text-sm px-4 py-2 rounded-md hover:bg-gray-800">
          Add Category
        </Link>
      </div>
            ...
            {rows.map((category) => (
              <tr key={category._id}>
                ...
                <td className="px-4 py-3 space-x-3">
                  <Link href={`/categories/${category._id}/edit`} className="btn-action btn-action-blue">Edit</Link>
