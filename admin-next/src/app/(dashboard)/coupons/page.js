...
import { fetchCoupons, deleteCoupon, fetchCouponAnalytics } from '../../../lib/api/coupons';
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        {tab === 'list' && (
          <Link href="/coupons/new" className="bg-gray-900 text-white text-sm px-4 py-2 rounded-md hover:bg-gray-800">
            Add Coupon
          </Link>
        )}
      </div>
                ...
                {coupons.map((coupon) => (
                  <tr key={coupon._id}>
                    ...
                    <td className="px-4 py-3 space-x-3">
                      <Link href={`/coupons/${coupon._id}/edit`} className="btn-action btn-action-blue">Edit</Link>
