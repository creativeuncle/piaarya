  ...
  return (
    <header className="bg-gray-900 text-white relative">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="text-xl font-black tracking-tight md:static absolute left-1/2 -translate-x-1/2 md:translate-x-0">
          PIAARYA
        </Link>
        ...
        <div className="flex items-center gap-5">
          ...
          {isAuthenticated ? (
            ...
            >
              <Link href="/dashboard/profile" aria-label="Account" className="relative flex items-center justify-center w-8 h-8 rounded-full bg-white/10 cursor-pointer">
              ...
              {accountMenuOpen && (
                <div className="absolute top-full right-0 mt-2 bg-white text-gray-900 rounded-md shadow-lg py-2 min-w-[160px] z-20">
                  <Link href="/dashboard/profile" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-50">
